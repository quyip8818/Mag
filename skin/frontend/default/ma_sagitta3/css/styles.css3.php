...
button.button span,.ma-mostview-products .item .label-pro-sale,
...
.drop-lang .sub-lang li a,.drop-currency .sub-currency li a,.wrapper_box #shopping_cart, .wrapper_box #continue_shopping,#back-top,.ma-banner8-container .flex-control-paging li a, .nivo-controlNav a,
.banner-static-contain .banner-box a,ul.tabs li,.producttabs .item h3 {
    -moz-transition: all 0.1s ease-in-out 0s;
...
,.pager .view-mode a.list,.pager .view-mode strong.list, .pager .view-mode a.list:hover,.pager .view-mode a.grid,
button.button:hover span,.pager .pages a:hover,.product-view .email-friend a:hover,.currency-language a:hover,
...
.drop-currency .sub-currency li a:hover,.wrapper_box #shopping_cart:hover, .wrapper_box #continue_shopping:hover,#back-top:hover,.ma-banner8-container .flex-control-paging li a:hover, .nivo-controlNav a:hover,
.banner-static-contain .banner-box:hover a,ul.tabs li:hover,.producttabs .item h3:hover {
...
.f-one-images:hover img{
    transform: scale(1.05); /* opera not support rotateX */
